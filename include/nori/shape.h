...
public:
    ...
    virtual void setParent(NoriObject* parent) override;
    ...
    const BSSRDF* getBSSRDF() const { return m_bssrdf; }

    const bool hasBSSRDF() const { return m_bssrdf!=nullptr; }
    ...
    Medium* get_int_medium() const { return int_medium; };
    Medium* get_ext_medium() const { return ext_medium; };
    bool isMedium() const {return int_medium!=nullptr|| ext_medium!=nullptr;};

protected:
    BSDF *m_bsdf = nullptr;      ///< BSDF of the surface
    BSSRDF* m_bssrdf = nullptr;  ///< BSSRDF of the surface
    Emitter *m_emitter = nullptr;     ///< Associated emitter, if any
    BoundingBox3f m_bbox;                ///< Bounding box of the mesh
    std::string int_medium_name="";
    std::string ext_medium_name="";
    Medium* int_medium = nullptr;
    Medium* ext_medium = nullptr;
